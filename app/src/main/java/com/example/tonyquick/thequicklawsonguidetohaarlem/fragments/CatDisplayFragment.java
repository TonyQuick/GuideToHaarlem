...
public class CatDisplayFragment extends Fragment {
    ...
    public static CatDisplayFragment newInstance(String param1, String param2) {
        CatDisplayFragment fragment = new CatDisplayFragment();
